...
const AboutMe = () => {
  return (
    <section className="h-[600px] w-full bg-[#16161c] relative py-[100px] px-[20px]">
      ...
      <div className="box bg-main-cream mt-[50px] absolute inset-0">
        <div className="container-primary py-[100px]">
          <div className="text-[60px] font-bold text-[#16161c] flex items-center max-w-[710px]">
            About Me
          ...
          <div className="text-[#16161c] flex flex-col gap-[20px]">
            <div>
              <div className="text-[20px] font-bold">What I do:</div>
            ...
            <div>
              <div className="text-[20px] font-bold">Why I Do It:</div>
              <p className="text-[17px] pl-[10px]">
