            ...
            <div className="max-w-[500px]">
              ...
              <div className="flex gap-[10px] tracking-[0.80px]">
                <div className="border-[2px] border-main-red-orange px-[6px] py-[3px] rounded-full">
                  <div className="text-main-gold text-[13px]">ReactJS</div>
                </div>
                <div className="border-[2px] border-main-red-orange px-[6px] py-[3px] rounded-full">
                  <div className="text-main-gold text-[13px]">NextJS</div>
                </div>
                <div className="border-[2px] border-main-red-orange px-[6px] py-[3px] rounded-full">
                  <div className="text-main-gold text-[13px]">TailwindCSS</div>
                </div>
              </div>
            </div>
          </div>
